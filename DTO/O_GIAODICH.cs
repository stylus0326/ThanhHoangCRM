...
namespace DataTransferObject
{
    public class O_GIAODICH
    {
        ...
        public Int64 KhachThanhToan { get; set; }
        public Int64 ThanhToan { get; set; }
        public Int64 KhachThanhToanNo { get; set; }
        public Int64 ThanhToanNo { get; set; }
        ...
        public O_GIAODICH(O_GIAODICH g)
        {
